            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://moe2.itch.io" target="_blank" rel="noopener noreferrer" 
                  ...
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M3.13 1.338C2.08 1.96.02 4.328 0 4.95v1.03c0 1.303 1.22 2.45 2.325 2.45 1.33 0 2.436-1.102 2.436-2.41 0 1.308 1.07 2.41 2.4 2.41 1.328 0 2.397-1.102 2.397-2.41 0 1.308 1.07 2.41 2.398 2.41 1.33 0 2.398-1.102 2.398-2.41 0 1.308 1.07 2.41 2.4 2.41 1.329 0 2.398-1.102 2.398-2.41 0 1.308 1.106 2.41 2.435 2.41C22.78 8.43 24 7.283 24 5.98V4.95c-.02-.622-2.08-2.99-3.13-3.612C18.97.678 17.018.18 12 .18S5.03.678 3.13 1.338zM12 7.7c-2.898 0-5.252 2.91-5.252 6.5 0 3.59 2.354 6.5 5.252 6.5 2.898 0 5.252-2.91 5.252-6.5 0-3.59-2.354-6.5-5.252-6.5zm0 11c-1.83 0-3.315-1.83-3.315-4.08s1.485-4.08 3.315-4.08 3.315 1.83 3.315 4.08-1.485 4.08-3.315 4.08z"/>
                  </svg>
                </a>
              </div>
            </div>
