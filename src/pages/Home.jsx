        ...
        <div className="max-w-screen-xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <SocialMediaCard
              ...
              hashtags={[
                { text: "#WebDevelopment", bgColor: "bg-red-100 dark:bg-red-900/50", textColor: "text-red-800 dark:text-red-300", borderColor: "border-red-200 dark:border-red-700" },
                { text: "#GameDev", bgColor: "bg-blue-100 dark:bg-blue-900/50", textColor: "text-blue-800 dark:text-blue-300", borderColor: "border-blue-200 dark:border-blue-700" }
              ]}
            ...
            <SocialMediaCard
              ...
              hashtags={[
                { text: "#CodeLife", bgColor: "bg-pink-100 dark:bg-pink-900/50", textColor: "text-pink-800 dark:text-pink-300", borderColor: "border-pink-200 dark:border-pink-700" },
                { text: "#TechCreator", bgColor: "bg-purple-100 dark:bg-purple-900/50", textColor: "text-purple-800 dark:text-purple-300", borderColor: "border-purple-200 dark:border-purple-700" }
              ]}
